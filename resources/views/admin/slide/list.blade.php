			            ...
			            <div class="box-body">
			                <table id="example2" class="table table-bordered table-hover">
		                    	...
		                    	@foreach ($slide as $item)
		                    		<tr>
			                            <td>{{ $item->link }}</td>
			                            <td><img src="public/upload/slide/{{ $item->image }}" width="200px"></td>
			                            ...
			                            <td  class="text-center">
			                            	<a href="admin/slide/sua/{{ $item->id }}"><button type="button" class="btn btn-warning"><i class="fa fa-edit"></i>Sửa</button></a>
